<?php
    ...
    function binh_luan_insert($noi_dung, $ma_sp, $ma_kh, $ngay_bl){
        $sql = "INSERT INTO binh_luan(noi_dung, ma_sp, ma_kh, ngay_bl) VALUES(?,?,?,?)";
        pdo_execute($sql, $noi_dung, $ma_sp, $ma_kh, $ngay_bl);
       }
